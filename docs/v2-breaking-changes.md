...
- Library providers: [Plex](./providers/library/plex.md) (`plex`), [Jellyfin](./providers/library/jellyfin.md) (`jellyfin`), [Emby](./providers/library/emby.md) (`emby`)
- List providers: [AniList](./providers/list/anilist.md) (`anilist`), [MyAnimeList](./providers/list/mal.md) (`mal`), [Trakt](./providers/list/trakt.md) (`trakt`)
